    ...
    <div className="app-container">
      ...
      <main className="w-full relative">
        ...
        <div className="w-full max-w-[1550px] mx-auto flex items-start justify-center relative px-2">
          ...
          <div className="hidden xl:block sticky top-24 w-[250px] 2xl:w-[320px] shrink-0 mr-4 mt-8">
            <AdBanner 
          ...
          <div className="flex-1 w-full max-w-[1200px]">
            ...
            <div className="w-full px-2 lg:px-4 mt-4 mb-2">
              <AdBanner 
          ...
          <div className="hidden xl:block sticky top-24 w-[250px] 2xl:w-[320px] shrink-0 ml-4 mt-8">
            <AdBanner 
